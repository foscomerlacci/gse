...
// "templates.000" to be used to change the color of a specific CKEditor instance
// available in the page. When a color change is required, this templates.000 is
...
CKEDITOR.skin.chameleon = (function() {
    ...
    // several places of our templates.000.
    ...
    // Style templates.000 for various user interface parts:
    // * Default editor templates.000.
    // * Default panel templates.000.
        templates = {
    ...
    return function(editor, part) {
        ...
        // The following are CSS styles used in templates.000.
...
//			'superscript,table,templates.000-rtl,templates.000,textarea-rtl,textarea,' +
